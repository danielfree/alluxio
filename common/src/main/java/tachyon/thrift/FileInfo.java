...
public class FileInfo implements org.apache.thrift.TBase<FileInfo, FileInfo._Fields>, java.io.Serializable, Cloneable, Comparable<FileInfo> {
  ...
  private static final org.apache.thrift.protocol.TField BLOCK_LENGTH_FIELD_DESC = new org.apache.thrift.protocol.TField("blockLength", org.apache.thrift.protocol.TType.I64, (short)18);
  ...
  public long blockLength; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    TTL((short)17, "ttl"),
    BLOCK_LENGTH((short)18, "blockLength");
  ...
  private static final int __BLOCKLENGTH_ISSET_ID = 12;
  ...
  static {
    ...
    tmpMap.put(_Fields.TTL, new org.apache.thrift.meta_data.FieldMetaData("ttl", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
    tmpMap.put(_Fields.BLOCK_LENGTH, new org.apache.thrift.meta_data.FieldMetaData("blockLength", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
  ...
  public FileInfo setBlockLength(long blockLength) {
    this.blockLength = blockLength;
    setBlockLengthIsSet(true);
    return this;
  }

  public void unsetBlockLength() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __BLOCKLENGTH_ISSET_ID);
  }

  /** Returns true if field blockLength is set (has been assigned a value) and false otherwise */
  public boolean isSetBlockLength() {
    return EncodingUtils.testBit(__isset_bitfield, __BLOCKLENGTH_ISSET_ID);
  }

  public void setBlockLengthIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __BLOCKLENGTH_ISSET_ID, value);
  }
  ...
  public boolean equals(FileInfo that) {
    ...
    boolean this_present_blockLength = true;
    boolean that_present_blockLength = true;
    if (this_present_blockLength || that_present_blockLength) {
      if (!(this_present_blockLength && that_present_blockLength))
        return false;
  ...
  public int hashCode() {
    ...
    boolean present_blockLength = true;
    list.add(present_blockLength);
    if (present_blockLength)
      list.add(blockLength);
  ...
  public int compareTo(FileInfo other) {
    ...
    lastComparison = Boolean.valueOf(isSetBlockLength()).compareTo(other.isSetBlockLength());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBlockLength()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.blockLength, other.blockLength);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class FileInfoStandardScheme extends StandardScheme<FileInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, FileInfo struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 18: // BLOCK_LENGTH
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.blockLength = iprot.readI64();
              struct.setBlockLengthIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FileInfo struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(BLOCK_LENGTH_FIELD_DESC);
      oprot.writeI64(struct.blockLength);
      oprot.writeFieldEnd();
